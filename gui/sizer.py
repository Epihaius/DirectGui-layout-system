...
class Sizer:
    ...
    def __init__(self, prim_dir, prim_limit=0, gaps=(0, 0)):
        ...
        # max. number of cells in each row (horizontal growth) or column
        # (vertical growth)
    ...
    def __getitem__(key):
        ...
        if key == "guiId":
            ...
            return self.prim_dir
        elif key == "prim_limit":
            return self.prim_limit
        elif key == "gaps":
            return self.gaps
